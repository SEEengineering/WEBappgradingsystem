...
class AppNavbar extends Component {
  ...
  render() {
    return <Navbar color="dark" dark expand="md">
      <NavbarBrand tag={Link} to="/home">Grading system</NavbarBrand>
      <Nav className="mr-auto">
        <NavLink href="/home">Home</NavLink>
        {this.state.showUser && <NavLink href="/users">all Users(admin only)</NavLink>}
        {this.state.showTeacher && <NavLink href="/pm">Teacher</NavLink>}
        {this.state.showAdmin && <NavLink href="/admin">Student</NavLink>}
      </Nav>
